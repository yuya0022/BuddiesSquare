    ...
    public function run()
    {
        ...
        $params = [
            ...
            [
                ...
                ['2024-06-15', '東京ドーム'], ['2024-06-16', '東京ドーム']
            ],
            [
                ['2024-03-30', '幕張メッセ']
            ],
            [
                ['2024-04-07', '幕張メッセ'], ['2024-04-29', '京都パルスプラザ']
            ],
            [
                ['2024-05-09', '幕張メッセ'], ['2024-05-10', '幕張メッセ']
            ],
            [
                ['2024-08-11', '幕張メッセ'], ['2024-08-31', '京都パルスプラザ']
            ],
            [
                ['2024-08-23', '幕張メッセ'], ['2024-08-24', '幕張メッセ'], ['2024-08-25', '幕張メッセ']
            ],
            [
                ['2024-09-12', '国立代々木競技場 第一体育館'], ['2024-09-13', '国立代々木競技場 第一体育館']
            ],
            [
                ['2024-11-23', 'ZOZOマリンスタジアム'], ['2024-11-24', 'ZOZOマリンスタジアム']
            ]
        ];
